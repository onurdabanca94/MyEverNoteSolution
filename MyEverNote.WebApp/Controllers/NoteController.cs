...
namespace MyEverNote.WebApp.Controllers
{
    ...
    public class NoteController : Controller
    {
        ...
        {
            //Note Class'ının Evernote ile ilişkili olan property'sinin ismini yazmak gerekiyor. Entities -> Note -> Owner
        ...
        public ActionResult Create(Note note)
        {
            ...
            {
                note.Owner = CurrentSession.User; //Bunu vermeseydik eklenen not kullanıcısız olarak insert olur.
        ...
        public ActionResult GetLiked(int[] ids)
        {
            if (CurrentSession.User != null)
            {
                ...
                // Şu an login olan kullanıcının like'larını getir.
                // Ve şu id'lerin içerisindeki id'leri getir. ids ile geliyor.
                if (ids != null)
                {
        ...
        //GetLiked ve SetLikeState login gerektiriyor fakat bunları JavaScript ile çağırıp kontrollerini yaptığımız için login kontrolüne gerek yok Js tarafında kişi login değilse otomatik olarak bağlantı hatası alıyor. 
