    ...
    public class EvernoteUserManager : ManagerBase<EvernoteUser>
    {
        public BusinessLayerResult<EvernoteUser> RegisterUser(RegisterViewModel data)
        {
            ...
            if (user != null)
            {
                ...
                {
                    res.AddError(ErrorMessageCode.EmailAlreadyExists, "E-posta zaten kayıtlı.");
                }
            }
            else
            { //Method hiding yapıldıüı için base.Insert olarak adresleme yapıldı.
                ...
                if (dbResult > 0)
                {
                    ...
                    //layerResult'ın Result nesnesine aktar.
        ...
        public BusinessLayerResult<EvernoteUser> LoginUser(LoginViewModel data)
        {
            ...
            {
                res.AddError(ErrorMessageCode.UsernameOrPassWrong, "Kullanıcı adı veya şifre yanlış!");
            }
...
//A) Metod gizleme tekniği var new anahtar kelimesi ile oluyor.
//B) Method hiding. yani insert yerine geçecek base class metodu çağrılma işlemi.
//C) Method hiding öncesinde Insert(res.Result); yapılsaydı kendini döndürüp duracaktı.
//D) Method hiding yapıldığı için base.Insert olarak adresleme yapıldı.

//Önceki metod'ta metod hiding yapılmadan önce yönetici için değil sıradan insert yapılıyordu (Şimdi varsayılan olarak gelecek) onun örneği;
// 1)
...
// 2)
//Activasyon Emaili kısmı olmayacak.
